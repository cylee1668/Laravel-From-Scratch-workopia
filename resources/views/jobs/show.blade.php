        ...
        <section class="md:col-span-3">
                    ...
                    @can('update', $job)
                        <div class="flex space-x-3 ml-4">
                            ...
                            <form method="POST" action="{{ route('jobs.destroy', $job->id) }}"
                                onsubmit="return confirm('Are you sure thart you want to delete this job?')">
                                @csrf
                                @method('DELETE')
            ...
            <div class="container mx-auto p-4">
                ...
                @auth
                    ...
                    <div x-data="{ open: false }" id="applicat-form">
                        <button @click="open = true"
                            class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
                            Apply Now
                        </button>
                        <div x-show="open"
                            class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-30">
                ...
                @else
                <p class="my-5 bg-gray-200 rounded-2xl p-3">
                    <i class="fas fa-info-circle mr-3"></i> You must be login to apply this job
                </p>
                @endauth
                ...
                <form method="POST"
                    ...
                    @else
                        <button
                            ...
                            <i class="fas fa-bookmark mr-3"></i> Bookmark Listings
                        </button>
                    @endif
